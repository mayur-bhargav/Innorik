...
function Home() {
  ...
  const [isAuthenticated, setIsAuthenticated] = useState(!!localStorage.getItem("jwtToken")); // Check if user is authenticated
          ...
          <div className="nav-links" id="navLinks">
            ...
            <ul>
              ...
              {localStorage.getItem("jwtToken") ? (
                <>
                  <li><a onClick={handleLogout} className='logout' style={{cursor:'pointer'}}>Logout</a></li>
                </>
              ) : (
                <>
                  <Link to="/login"><li><a className='logout'>Login</a></li></Link>
                  <Link to="/register"><li><a className='logout'>Register</a></li></Link>
                </>
              )}
            </ul>
          </div>
